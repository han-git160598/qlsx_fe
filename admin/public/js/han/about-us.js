...
function update_about_module(id) {
    ...
    $.ajax({
        ...
        data: {
            ...
            type_manager: 'update_about_mudule',
                    ...
                    <div class="wp-module">
                        <div class="module">
                            <div class="module-title">
                                ...
                                <span data-tag="a" data-id-slide="${item.id}" onclick="show_delete_about_about(${item.id})" type="delete_module" class="get_modal icon-close"><img src="public/images/x-black.png" alt=""></span>
                            </div>
