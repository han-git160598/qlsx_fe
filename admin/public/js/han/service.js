    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.success == 'true') {
                ...
                id_module_service = response.data[1].id;
                ...
                response.data.forEach(function(item) {
                    ...
                    <div class="module w-100">
                        <div class="module-title">
                            ...
                            <span data-tag="a" type="delete_module" onclick="show_delete_product_product(${item.id})" class="get_modal icon-close"><img src="public/images/x-black.png" alt=""></span>
                        </div>
