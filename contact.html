        ...
        <div id="wp-header">
            ...
            <nav class="bot-header">
                <ul id="main-menu">
                    ...
                    <li class="item active"><a href="contact.html">Liên hệ</a></li>
                </ul>
                <div class="dir-user">
                    <div class="dir-tx">
                            ...
                            <div class="box-item w-100">
                                ...
                                <div class="item-content">
                                    <p class="fw-400 d-flex">
                                        <span class="icon"><img src="public/images/detail-phone.png" alt=""></span>
                                        <span class="mg-l-05rem lh-12rem">(+84) 932 653 789</span>
                                    </p>
                                    <p class="fw-400 d-flex">
                                        <span class="icon"><img src="public/images/detail-location.png" alt=""></span>
                                        <span class="mg-l-05rem lh-12rem">A5/6c Nguyễn Cữu Phú, Ấp 01, Tân Kiên Huyện Bình Chánh, TP. Hồ Chí Minh</span>
                                    </p>
                                    <p class="fw-400 d-flex">
                                        <span class="icon"><img src="public/images/detail-gmail.png" alt=""></span>
